...
LAYER_QUERY_URLS = [
    ...
    # "https://services9.arcgis.com/1rOwFRpAwrxe0rBl/arcgis/rest/services/Transportation/FeatureServer/0/query?where=COVERED%20=%20%27No%27"
]

# Common ArcGIS Query params to fetch all features in WGS84 (lat/lon)
BASE_PARAMS = {
    "f": "json",
    "where": "UPPER(COVERED) = 'No'",               # no filter
    "outFields": "*",
    "returnGeometry": "true",
...
np.savetxt("outputs/umd_racks_latlon.csv", points_latlon, delimiter=",", header="lat,lon", comments="")
with open("outputs/umd_racks_latlon.json", "w") as f:
